...
export default function Wallet() {
    ...
    return (
        <main className="flex-1 flex flex-col relative overflow-hidden h-screen">
            {/* Header */}
            <header className="pt-12 pb-2 px-6 flex justify-between items-center z-10 bg-background-dark/80 backdrop-blur-md sticky top-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h2 className="text-lg font-bold text-white leading-tight">Laszlo Foldvary</h2>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pb-24">
                        ...
                        <div className="flex gap-4 pb-4 px-6 w-max">
                            ...
                            <div className="snap-start shrink-0 w-[280px] h-[178px] rounded-2xl bg-gradient-to-br from-accent/60 to-surface-dark/80 p-6 flex flex-col justify-between shadow-lg backdrop-blur-md border border-white/10 transform transition-transform hover:scale-[1.02] cursor-pointer group">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <span className="text-2xl font-mono text-white tracking-widest">••••</span>
                                        <span className="text-2xl font-mono text-white tracking-widest">••••</span>
                                        <span className="text-2xl font-mono text-white tracking-widest">4242</span>
                                    </div>
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <p className="text-xs text-white/60 uppercase font-medium">Card Holder</p>
                                            <p className="text-sm text-white font-medium tracking-wide">Laszlo Foldvary</p>
                                        </div>
                            ...
                            <div className="snap-start shrink-0 w-[280px] h-[178px] rounded-2xl bg-gradient-to-br from-surface-highlight to-surface-dark p-6 flex flex-col justify-between shadow-lg backdrop-blur-md border border-white/10 transform transition-transform hover:scale-[1.02] cursor-pointer group">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <span className="text-2xl font-mono text-white tracking-widest">••••</span>
                                        <span className="text-2xl font-mono text-white tracking-widest">••••</span>
                                        <span className="text-2xl font-mono text-white tracking-widest">8899</span>
                                    </div>
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <p className="text-xs text-white/60 uppercase font-medium">Card Holder</p>
                ...
                <div className="px-6 grid grid-cols-4 gap-4 mb-8">
                    <button className="flex flex-col items-center gap-2 group">
                        <div className="h-14 w-14 rounded-full bg-surface-dark group-hover:bg-primary/20 flex items-center justify-center transition-all duration-300">
                    ...
                    <button className="flex flex-col items-center gap-2 group">
                        ...
                        <span className="text-xs font-medium text-gray-300">Bill Pay</span>
                    </button>
                    <button className="flex flex-col items-center gap-2 group">
                        <div className="h-14 w-14 rounded-full bg-surface-dark group-hover:bg-primary/20 flex items-center justify-center transition-all duration-300">
                            <span className="material-symbols-outlined text-white group-hover:text-primary transition-colors">
                ...
                {/* Recent Transactions */}
                <div className="bg-surface-dark/50 rounded-t-3xl min-h-[400px] border-t border-white/5 backdrop-blur-sm">
                    ...
                    <div className="px-4 space-y-2">
                        {[
                            ...
                            <div
                                key={i}
                                className="group flex items-center justify-between p-3 rounded-xl hover:bg-surface-dark/50 transition-colors cursor-pointer min-h-[72px]"
                            >
                                <div className="flex items-center gap-4">
                                    <div className={`h-12 w-12 rounded-xl bg-surface-dark flex items-center justify-center ${tx.color} group-hover:scale-105 transition-transform`}>
                                        <span className="material-symbols-outlined">{tx.icon}</span>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-base font-medium text-white">{tx.name}</span>
                                        <span className="text-sm text-gray-400">{tx.time}</span>
                                    </div>
                                </div>
                                <span className={`text-base font-semibold font-mono ${tx.amount.startsWith('+') ? 'text-emerald-400' : 'text-white'}`}>
                                    {tx.amount}
                                </span>
                            </div>
                        ))}
