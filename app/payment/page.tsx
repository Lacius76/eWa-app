        ...
        <>
            ...
            <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
                <div className="flex items-center justify-between px-4 h-14">
                    <Link
                        href="/"
                        className="flex items-center justify-center w-10 h-10 -ml-2 rounded-full active:bg-white/10 text-text-primary transition-colors"
                    >
                        <span className="material-symbols-outlined !text-[28px]">chevron_left</span>
                    </Link>
                    <h1 className="text-base font-semibold text-text-primary tracking-wide">Confirm Payment</h1>
            ...
            <main className="flex-1 flex flex-col px-4 pt-6 pb-24 overflow-y-auto no-scrollbar max-w-md mx-auto w-full">
                ...
                <Card withGlow className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-lg font-semibold text-text-primary">
                                Passenger Car <span className="text-sm font-normal text-text-secondary ml-1">(Class B)</span>
                            </p>
                        </div>
                    ...
                    <div className="bg-surface rounded-xl p-4 border border-border flex items-center justify-between">
                        <div className="flex flex-col">
                            <span className="text-xs text-text-secondary uppercase tracking-wider mb-1">License Plate</span>
                        ...
                        <div className="bg-surface rounded-2xl p-1 border border-border space-y-1">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-text-primary font-medium text-sm">3-Day Vignette</p>
                                        <p className="text-text-secondary text-xs">Short visit</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-text-primary font-medium text-sm">10-Day Vignette</p>
                                        <p className="text-text-secondary text-xs">Standard duration</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-text-primary font-medium text-sm">30-Day Vignette</p>
                                        <p className="text-text-secondary text-xs">Popular choice</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-text-primary font-medium text-sm">1-Year Vignette</p>
                                        <p className="text-text-secondary text-xs">Best value</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-2">
                        <div>
                            <p className="text-xs text-text-secondary mb-1">Validity Period</p>
                        ...
                        <div className="col-span-2 flex justify-between text-xs text-text-secondary pt-2">
                            <span>
                                Valid from: <span className="text-text-primary">Aug 12, 2023</span>
                            </span>
                            <span>
                                To: <span className="text-text-primary">Sep 11, 2023</span>
                            </span>
                        </div>
                    </div>
                </Card>
                ...
                <div className="bg-surface rounded-2xl p-1 border border-border space-y-1">
                    ...
                    <label className="relative flex items-center gap-4 p-4 rounded-xl cursor-pointer hover:bg-black/5 dark:hover:bg-white/5 transition-all opacity-60 hover:opacity-100">
                        ...
                        <div className="w-6 h-6 rounded-full border-2 border-text-secondary" />
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/90 backdrop-blur-xl border-t border-border z-[100]">
                <div className="max-w-md mx-auto w-full flex flex-col gap-3">
                    <div className="flex justify-between items-end px-1 mb-1">
                        ...
                        <span className="text-2xl font-bold text-text-primary tracking-tight">€{vignetteOptions[selectedVignette].price}</span>
                    </div>
                    <Button
