        ...
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-background-dark px-6">
            ...
            <div className="relative z-10 w-full max-w-md space-y-8">
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    <button
                        type="button"
                        className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-surface-dark py-3.5 font-medium text-white transition-all hover:bg-surface-highlight hover:border-white/20 active:scale-[0.98]"
                    >
