    ...
    <>
      ...
      <main className="flex-1 px-4 pb-24">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 auto-rows-auto">
          ...
          <Link
            href="/parking"
            className="col-span-2 relative overflow-hidden rounded-3xl bg-surface p-5 shadow-sm ring-1 ring-border group transition-transform active:scale-[0.98]"
          >
            <div className="absolute right-4 top-1/2 -translate-y-1/2 w-28 h-28 transform rotate-3 scale-110 pointer-events-none">
              <img
                src="/parking.png"
                alt="Parking"
            ...
            <div className="relative z-20 flex flex-row items-center justify-between h-full">
              <div className="flex flex-col justify-between h-full gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-text-primary leading-tight">Smart Parking</h4>
                  <p className="text-xs text-text-secondary mt-1">Find spots nearby</p>
                  <div className="mt-3 flex items-center gap-2 bg-surface/80 backdrop-blur-sm rounded-full w-fit px-2 py-1 pr-3 shadow-md">
                    <span className="flex h-2 w-2 relative">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
                    </span>
                    <p className="text-xs font-medium text-emerald-500 dark:text-emerald-400">2h 15m remaining</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div>
              <h4 className="text-base font-bold text-text-primary">e-Vignette</h4>
              <p className="text-xs text-text-secondary mt-1 line-clamp-1">Valid until Dec 2024</p>
            </div>
          </Link>
          ...
          <Link
            href="/mobile-ticket"
            className="col-span-1 relative overflow-hidden rounded-3xl bg-surface p-5 shadow-sm ring-1 ring-border flex flex-col justify-between group h-44 transition-transform active:scale-[0.98] cursor-pointer"
          >
            <div className="flex justify-between items-start">
            ...
            <div>
              <h4 className="text-base font-bold text-text-primary">Mobile Ticket</h4>
              <p className="text-xs text-text-secondary mt-1">Bus &amp; Train</p>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <h4 className="text-base font-bold text-text-primary">Insurance</h4>
                <p className="text-xs text-text-secondary">Auto &amp; Home coverage</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <h4 className="text-base font-bold text-text-primary">My Wallet</h4>
                <p className="text-xs text-text-secondary">Cards &amp; Transactions</p>
              </div>
            </div>
            <div className="h-8 w-8 rounded-full border border-border flex items-center justify-center">
              <span className="material-symbols-outlined text-text-secondary" style={{ fontSize: '20px' }}>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <h4 className="text-base font-bold text-text-primary">Tickets</h4>
                <p className="text-xs text-text-secondary">Cinema, Concerts &amp; Theater</p>
              </div>
            </div>
            <div className="h-8 w-8 rounded-full border border-border flex items-center justify-center">
              <span className="material-symbols-outlined text-text-secondary" style={{ fontSize: '20px' }}>
